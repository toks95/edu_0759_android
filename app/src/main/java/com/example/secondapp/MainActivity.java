...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MainActivity.this));//LinerLayout - положение данных списком, не клеточками (Grid)
    ...
    private void recyclerViewInit(){
        ...
        userAdapter = new UserAdapter(userList);//Adapter считывает элементы и передает в RecycleView (для отражения на экране)
        ...
        /*for (int i = 0; i < 100; i++) {
            ...
            users.add(user);
        }*////100 пользователей в коллекции Users, используется цикл, пока нет БД
    }
    ...
    private  class UserHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        User user;
        public UserHolder(LayoutInflater inflater, ViewGroup viewGroup) { //на входе принимаются два элемента
